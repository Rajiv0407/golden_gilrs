    ...
    function mobileMenuHide(){
        if($(window).width() < 980) {
            $('.grid-container').removeClass('collapse_grid_container');
        }
    }
...
function userDetailData(id,type=1,divId='image'){ 
    ajaxCsrf();
   $.ajax({type:"POST",
   url:baseUrl+'/userDetailData',
...
function event_booking_detail(id) {
     ajaxCsrf();     
    $.ajax({
        type: "post",
        url: baseUrl +'/event_booking_detail',  
        cache: 'FALSE',
		dataType:'html',  
        data: { 'id': id },
         beforeSend:function(){
...
function goodies_booking_detail(id) {
     ajaxCsrf();     
    $.ajax({
        type: "post",
        url: baseUrl +'/goodies_booking_detail',  
        cache: 'FALSE',
		dataType:'html',  
        data: { 'id': id },
         beforeSend:function(){
	...
	function eventfeetypeList(){
		
        ajaxCsrf();
        mobileMenuHide();
        $.ajax({
        type: "post",
        url: baseUrl+'/event_fee_type_list',  
        cache: 'FALSE',
		dataType:'html',
        beforeSend: function () {
       // ajax_before();
	...
	function goodiesBookingRequest(){  
        ajaxCsrf();
        mobileMenuHide();
        $.ajax({
        type: "post",
        url: baseUrl+'/goodies_booking_list',           
        cache: 'FALSE',
		dataType:'html',
        beforeSend: function () {
       // ajax_before();
	...
	function eventBookingRequest(){  
        ...
        $.ajax({
        type: "post",
        url: baseUrl+'/event_booking_list',         
        cache: 'FALSE',
		dataType:'html',
        beforeSend: function () {
       // ajax_before();
...
function vehicleBookingDetail(bookingId,type=1){
  ...
  function customerManagement(){
	...
	function adminUserManagement(){
        ...
        $.ajax({
        type: "POST",
        url: baseUrl+'/adminusersManagement',
        cache: 'FALSE',
        beforeSend: function () {
        ajax_before();
        },
