      ...
      <?php if(count($post_image) > 0){ ?>
        ...
        <div class="Photoupload_wrapp">
          <div class="head">
             <h3>Photos</h3>
             <div class="addlnkscl">
               <button type="button" class="btn lbl_btn" data-bs-toggle="modal" data-bs-target="#addstory1" onclick="addPhotoPopup();">
          ...
          <div class="list_stories" id="profile_photo_listing">
...
<div class="loadmorebtn">
  <button id="homeLoadmore" class="btn" onclick="ajax_myphoto(<?php echo $data['user_id'] ; ?>)"><div class="spinner-border" id="loadmorebtn_loader" style="display:none;" role="status">
...
</script><?php /**PATH D:\xampp\htdocs\golden\resources\views/website/pages/Profile/Photos.blade.php ENDPATH**/ ?>