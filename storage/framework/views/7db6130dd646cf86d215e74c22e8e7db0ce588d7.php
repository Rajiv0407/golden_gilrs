<form id="edit_comment_forms_id" action="javascript:void(0);" enctype="multipart/form-data" method="post">  
					<div class="aef_bx">
					  <input type="hidden" name="edit_commentId" class="form-controll" value="<?php echo $commentInfo->id ; ?>">  
						...
						<button class="btn" type="button" onclick="updateComment('<?php echo $commentInfo->post_id ; ?>')">Update</button>
						</div>
				    </div>
						
					
				</form><?php /**PATH C:\xampp\htdocs\golden\resources\views/edit_comment.blade.php ENDPATH**/ ?>