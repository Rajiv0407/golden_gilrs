<form id="edit_comment_forms_id" action="javascript:void(0);" enctype="multipart/form-data" method="post">  
					<div class="aef_bx">
					  <input type="hidden" name="edit_commentId" class="form-controll" value="<?php echo $commentInfo->id ; ?>">  
						...
						<button class="btn" type="button" onclick="updateGoodiesComment('<?php echo $commentInfo->goodies_id ; ?>')">Update</button>
						</div>
				    </div>
				...
				<?php /**PATH C:\xampp\htdocs\golden\resources\views/editGoodiesComment.blade.php ENDPATH**/ ?>