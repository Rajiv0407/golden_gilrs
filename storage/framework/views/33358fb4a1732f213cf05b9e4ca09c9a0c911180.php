                            ...
                            <tr>
                              <td valign="top" style="font-family:Arial,Sans-serif;font-size:12px">
                                ...
                                <table style="font-family:'roboto';width: 100%;     margin-top: 20px;padding: 20px;">
                                  <tbody>
                                    <tr>
                                      <td style="font-size:23px;padding:5px 0;padding-bottom: 40px;"><b> Hi <?php echo e($user_name); ?> ! </b></td>
                                    </tr>
                                        ...
                                        <table style="font-family: 'roboto';  background: #f9f9f9; padding: 10px" width="100%">
                                          <tbody>
											...
											<tr>
                                            	 ...
                                            	 <b>	Booking Email id </b>: <?php echo e($email); ?> 
                                            	 </td>
                                            </tr>
                                            <tr>
                                            	 <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                            	 <b>	Order Id: </b> <?php echo e($booking_id); ?>
                                                ...
                                                <?php if($booking_type == 1){  ?>
                                            	 	<b>Event Name:</b> <?php echo e($booking_name); ?>

                                               <?php } ?>
                                                <?php if($booking_type == 2){  ?>
                                                <b>Goodies Name:</b> <?php echo e($booking_name); ?>
											...
											<tr>
                                            	 <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                                <?php if($booking_type == 1){  ?>
                                            	 	<b>Event Date:</b> <?php echo e($date); ?>

                                               <?php } ?>
                                               <?php if($booking_type == 2){  ?>
                                                <b> Goodies Date: </b> <?php echo e($date); ?>
                                            ...
                                            <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                                 <?php if($booking_type == 1){  ?>
                                            	 	 <b>Event Time:</b> <?php echo e($time); ?>

                                                <?php } ?>
                                                <?php if($booking_type == 2){  ?>
                                                 <b>Goodies Time:</b> <?php echo e($time); ?>
                                            ...
                                            <tr>
                                            <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                                <b> Ticket Quantity:</b> <?php echo e($no_ticket); ?>
											...
											<tr>
                                                ...
                                                <?php if($status== "Approved"){ ?>
                                            	 	<b>Booking Status:</b> <span style="color:green"><?php echo e($status); ?> </span> 
                                               <?php } ?>
                                               <?php if($status== "Cancel"){ ?>
                                                <b>Booking Status:</b><span style="color:red">Cancelled</span> 
                                               <?php } ?>
                                            	 </td>
                                            </tr>
                                            <tr>
                                               <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                                <?php if($booking_type == 1){  ?>
                                                <b>Event Address:</b> <?php echo e($address); ?>

                                               <?php } ?>
                                               <?php if($booking_type == 2){  ?>
                                               <b> Goodies Address:</b> <?php echo e($address); ?>
...
</html><?php /**PATH C:\xampp\htdocs\golden\resources\views/emails/booking.blade.php ENDPATH**/ ?>