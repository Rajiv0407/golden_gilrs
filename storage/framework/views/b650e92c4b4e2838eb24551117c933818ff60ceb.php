...
<?php } else if(!empty($users['gender']) || !empty($users['know']) || ($user_id!=$data['userId'] && (($users['isPrivate']==0 && $users['isDOBPrivacy']==1) || ($users['isPrivate']==0 && $users['isFriend']==1 && $users['isDOBPrivacy']==2) || ($users['isPrivate']==1 && $users['isFriend']==1 && ($users['isDOBPrivacy']==1 || $users['isDOBPrivacy']==2))))){ ?> 
<div class="section_rept">
        <div class="head">
            <h3>Basic Info</h3>
        ...
        <div class="group_form threeclm">
            ...
            <?php } ?>
                ...
                <?php  if($user_id!=$data['userId'] && (($users['isPrivate']==0 && $users['isDOBPrivacy']==1) || ($users['isPrivate']==0 && $users['isFriend']==1 && $users['isDOBPrivacy']==2) || ($users['isPrivate']==1 && $users['isFriend']==1 && ($users['isDOBPrivacy']==1 || $users['isDOBPrivacy']==2)))){ ?> 
                         <div class="fgwi">
                <div class="icon">
                    <i class="fa fa-birthday-cake"></i>
                </div>
...
</script><?php /**PATH D:\xampp\htdocs\golden\resources\views/website/pages/Profile/about.blade.php ENDPATH**/ ?>