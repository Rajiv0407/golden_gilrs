...
<?php $data=session()->get('user_session');   ?>
  <div class="head">
    <h3>Who to Follow</h3>
    <a class="ank_btn text-decoration-underline" href="<?php echo e(URL::to('/')); ?>/network/<?php echo $data['userId'];  ?>">View All</a>  
  </div>
        ...
        <div class="user_avtar">
          ...
          <div class="user_details">
            <div>
              ...
              <h3><a class="ank_btn text-decoration-underline" href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $follow->id ;  ?>">
                <span>
...
<?php } ?>
	...
	</script><?php /**PATH D:\xampp\htdocs\golden\resources\views/rightmenu/follow.blade.php ENDPATH**/ ?>