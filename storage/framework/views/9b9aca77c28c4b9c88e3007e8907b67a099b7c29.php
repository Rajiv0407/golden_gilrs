					...
					<div class="post_user">
						<div class="user_avtar">
							...
							<div class="user_details">
								<div>
									<h3><a 
										<?php if($loginUserId==0){ ?>href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#login_post" <?php } else { ?>href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $post_infos['post_user_id']; ?>" <?php } ?>
										>
...
</html><?php /**PATH C:\xampp\htdocs\golden\resources\views/home_page_detail.blade.php ENDPATH**/ ?>