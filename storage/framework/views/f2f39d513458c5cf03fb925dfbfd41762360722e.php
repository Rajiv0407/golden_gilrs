...
<form action="javascript:void(0);" method="post" id="editCountryForm" enctype="multipart/form-data">  
    ...
    <div class="form modal-form">
		...
		<select name="edit_country_status" id="edit_country_status" class="form-control">
			...
			<option value="1" <?php echo e($countryInfo->flag == "1"? 'selected' : ''); ?>> Active</option>
			<option value="0" <?php echo e($countryInfo->flag == "0"? 'selected' : ''); ?>>In Active</option>
		</select>
...
</form><?php /**PATH C:\xampp\htdocs\golden\resources\views/admin/master/country/editCountry.blade.php ENDPATH**/ ?>