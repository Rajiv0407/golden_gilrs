<form id="edit_reply_comment_forms_id" action="javascript:void(0);" enctype="multipart/form-data" method="post">  
					<div class="aef_bx">
					  <input type="hidden" name="edit_reply_commentId" class="form-controll" value="<?php echo $replyInfo->id ; ?>">  
						...
						<button class="btn" type="button" onclick="updateEventReplyComment('<?php echo $replyInfo->event_id ; ?>')">Update</button>
						</div>
				    </div>
						
					
				</form><?php /**PATH C:\xampp\htdocs\golden\resources\views/eventReplyComment.blade.php ENDPATH**/ ?>