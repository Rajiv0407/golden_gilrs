  ...
  <div class="Box_details_sect">
    ...
    <div class="Invitations_sect mt-3">
      ...
      <div class="invit_inner">
        ...
        <div class="crd_bx">
          <a href="<?php echo e(URL('/').'/profile/'.$user_requests->id); ?>" style=" text-decoration: none !important;">
          <div class="user_avtar">
            ...
            <div class="user_details">
              ...
              <div class="prof_location"><img src="<?php echo e(URL::to('/public/website')); ?>/images/map-marker-alt.svg" alt="">
                <ul>
                  <li>
      ...
      ?>
        <div class="fcrd_rptr">
          <div class="fpbx">
            ...
            <div class="data">
              <h3><a href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $neartest_friend->id; ?>"><?php echo $neartest_friend->name; ?></a></h3>
...
<?php echo $__env->make('includes.website.ajax_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\golden\resources\views/website/pages/network/network.blade.php ENDPATH**/ ?>