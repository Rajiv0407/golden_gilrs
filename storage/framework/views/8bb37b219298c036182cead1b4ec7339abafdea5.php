...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(URL::to('/public/website')); ?>/css/bootstrap.min.css">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::to('/public/website')); ?>/css/only_login.css?v=<?php echo e(time()); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::to('/public/website')); ?>/css/loveround-font/lovoround-fonts.css">
...
<body>
  ...
  <header class="navbar_menu login_header">
    <div class="container-custom">
      ...
      <nav class="navbar navbar-expand-lg ">
        <a class="navbar-brand" href="#"><img src="<?php echo e(URL::to('/public/website')); ?>/images/logo.png?v=<?php echo time() ; ?>" alt="">
    ...
    <div class="login_wrapp">
      <div class="login_inner">
        <div class="login_card">
          ...
          <div class="hd_title">
            <!-- <a href="#" class="login"><img src="<?php echo e(URL::to('/public/website')); ?>/images/logo.svg" alt=""></a>   -->
        ...
        <div class="login_card">
          ...
          <div class="frm_sect">
            ...
            <form id="login_forms_id" action="javascript:void(0);" enctype="multipart/form-data" method="post">
              ...
              <div class="frm_grp"></div>
              <!--- <div id="loadingGife" style="display: none;"><img src="<?php echo e(URL::to('/public/website')); ?>/images/loader.gif"></div> -->
            ...
            <form id="forgot_forms_id" action="javascript:void(0);" enctype="multipart/form-data" method="post">
              ...
              <div class="btn_login frm_grp">
                <div id="floadingGife" style="display: none;">
                  <!-- <img src="<?php echo e(URL::to('/public/website')); ?>/images/loader.gif"> -->
                </div>
  ...
  <script src="<?php echo e(URL::to('/public/website')); ?>/js/intlTelInput.js"></script>
  <script src="<?php echo e(URL::to('/public/website')); ?>/js/utils.js"></script>
  <script src="<?php echo e(URL::to('/public/website')); ?>/js/custom.js"></script>
  <script src="<?php echo e(URL::to('/public/website')); ?>/js/jquery.notyfy.js?v=<?php echo e(config('app.version')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(URL::to('/public/website')); ?>/js/notyfy.init.js?v=<?php echo e(config('app.version')); ?>" type="text/javascript"></script>
  <script>
    //country phone input
...
</html><?php /**PATH C:\xampp\htdocs\golden\resources\views//login.blade.php ENDPATH**/ ?>