...
<div class="notify_list_wrap">
             ...
             ?>
                    <a href="<?php echo e($redirectUrl); ?>" onclick="read_notification(<?php echo $notifications['id'] ?>,<?php echo $data['userId']; ?>)">
...
<?php echo $__env->make('includes.website.ajax_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\golden\resources\views/website/notification1.blade.php ENDPATH**/ ?>