<?php $session_data=session()->get('admin_session');  //echo "<pre>";print_r($session_data);die;   ?>
<div class="headerWrapper">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <!-- <a class="navbar-brand" href="#">
                <img src="<?php echo e(URL::to('/public/admin')); ?>/images/logo.png" alt="">
            </a> -->
            <div class="navbarContent navbar-right align-items-center w-100 justify-content-between d-flex">
                ...
                <ul class="nav navbar-nav gap-20 align-items-center">
                    <li class="welcome_s"> 
                        Welcome <span class="fw-500"><?php echo $session_data['userName']; ?></span>
                    </li>

                  <li><a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#adminChangePassword" onclick="adminChangePwd()" class="d-flex align-items-center">
                  <i class="ri-lock-line head_icon"></i>
                  <span>Change Password</span>
                </a>
            </li>
                    <?php if(Session::has('admin_session')): ?>
                    <li>
                        <a href="<?php echo e(URL::to('/')); ?>/administrator/logout" class="fs-18 d-flex align-items-center">
                            <!-- <i class="bi bi-box-arrow-in-right fs-4"></i> -->
                            <i class="ri-logout-box-r-line head_icon"></i>
                            <span>Logout</span>
                        </a>
                    </li>
                    <?php endif; ?> 
...
</script><?php /**PATH C:\xampp\htdocs\golden\resources\views/includes/admin/header.blade.php ENDPATH**/ ?>