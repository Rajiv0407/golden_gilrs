...
?>
    ...
    <a class="navbar-brand" href="#">
                <img src="<?php echo e(URL::to('/public/admin')); ?>/images/logo.svg" class="un-clp-logo" alt="">
    ...
    <ul class="height_navigation" id="letsgo_sidebar">
	    <?php if($dashboard== 1){ ?>
        <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#index" onclick="dashboard();"><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/dashboard.png"><span class="tooltip_nav">Dashboard</span></a></li>  
		<?php } ?>
		<?php if($AdminUser== 1){ ?>
        <li>
            <div class="admin_nav">
                <a class="" id="admin_n"><span><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/admin_user.png">
                ...
                <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#admin_users" onclick="adminUserManagement()">
	...
	<li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#customer_management" onclick="customerManagement()"><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/customer_management.png">
           <span class="tooltip_nav">
        Customer Management
    </span></a></li>
	<?php } ?>
	<?php if($EventManagement== 1){ ?>
	 <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#event" onclick="eventList()"><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/event_management.png">
           <span class="tooltip_nav">
        Event Management
    </span></a></li>
	<?php } ?>
	<?php if($CouponManagement== 1){ ?>
	<!--<li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#coupon" onclick="couponList()"><i class="ri-user-settings-line"></i>
           <span class="tooltip_nav">
        Coupon Management
    </span></a></li> -->
   <?php } ?>	
  <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#goodies" onclick="goodiesList()"><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/goodies_management.png">
           <span class="tooltip_nav">
        Goodies Management
  </span></a></li> 
  <?php if($BookingManagement== 1){ ?>
		<li>
            <div class="booking_nav">
                <a class="" id="booking_n"><span><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/booking_management.png">
                     <span class="tooltip_nav">Booking Management</span>
                </span> <span class="dropdown_tog"><i class="ri-arrow-drop-down-line"></i></span></a>
                <ul class="dropdown-menu" id="drop_booking_m"> 
				<?php if($EventBookingManagement== 1) { ?>
                <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#eventbooking" onclick="eventBookingRequest()">
                <i class="ri-arrow-right-s-line"></i>
                <span class="tooltip_nav">Event Booking Request</span>
                </a></li>
				<?php } ?>
				<?php if($GoodiesBookingManagement==1){ ?>
                 <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#goodiesbooking" onclick="goodiesBookingRequest()">
                <i class="ri-arrow-right-s-line"></i> 
       ...
       <?php if($CMS== 1){ ?>		
        <li>
            <div class="cms_nav">
                <a class="" id="drop_nav"><span><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/cms.png">
  ...
  <?php if($Master == 1){ ?>	 
        <li>
            <div class="master_nav">
                <a class="" id="master_n"><span><img src="<?php echo e(URL::to('/public/admin')); ?>/icon/master.png">
                     <span class="tooltip_nav">Master</span>
                </span> <span class="dropdown_tog"><i class="ri-arrow-drop-down-line"></i></span></a>
                <ul class="dropdown-menu" id="drop_content_m"> 
                <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#event_type" onclick="eventtypeList()">
                <i class="ri-arrow-right-s-line"></i>
                <span class="tooltip_nav">Event Type</span>
                </a></li>
                 <li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#event_fee_type" onclick="eventfeetypeList()">
                <i class="ri-arrow-right-s-line"></i>
                <span class="tooltip_nav">Event Fee Type</span>
                </a></li>
				<li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#country" onclick="country()">
                <i class="ri-arrow-right-s-line"></i>
                <span class="tooltip_nav">Country</span>
                </a></li>  
				<li><a href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#city" onclick="city()">
                <i class="ri-arrow-right-s-line"></i>
...
<?php /**PATH C:\xampp\htdocs\golden\resources\views/includes/admin/sidebar.blade.php ENDPATH**/ ?>