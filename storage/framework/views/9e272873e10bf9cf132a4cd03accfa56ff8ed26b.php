...
<div class="container-custom header">
  <nav class="navbar navbar-expand-lg ">
    ...
    <div class="logoMenu">
      ...
      <a class="navbar-brand" href="<?php echo URL('/home/') ; ?>"><img src="<?php echo e(URL::to('/public/website')); ?>/images/logo.svg?v=<?php echo time(); ?>" alt="">
        <?php 
    ...
    <div class="navmenu collapse navbar-collapse nav_menu" id="navbarSupportedContent">
      ...
      <div class="mobile-header">
        <div class="m_logo"><img src="<?php echo e(URL::to('/public/website')); ?>/images/logo.svg" alt=""></div>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="golden_header_bar">
          <li class="nav-item">
            <a class="nav-link <?php if (request()->segment(1) == 'home') {
                                  echo 'active';
                                } ?>" aria-current="page" href="<?php echo e(URL::to('/')); ?>/home">Home</a>
          </li>
          <li class="nav-item">
            <a id="goodies_style_id" class="nav-link <?php if (request()->segment(1) == 'goodies') {
                                                        echo 'active';
                                                      } ?>" href="<?php echo e(URL::to('/')); ?>/goodies">Goodies</a>

          </li>
          <li class="nav-item">
            <a id="life_style_id" class="nav-link <?php if (request()->segment(1) == 'life_style') {
                                                    echo 'active';
                                                  } ?>" href="<?php echo e(URL::to('/')); ?>/life_style">Lifestyle</a>

          </li>
          <li class="nav-item">
            <a class="nav-link <?php if (request()->segment(1) == 'group') {
                                  echo 'active';
                                } ?>" href="<?php echo e(URL::to('/')); ?>/group">Groups</a>
          </li>
          <li class="nav-item">
            <a class="nav-link <?php if (request()->segment(1) == 'message') {
                                  echo 'active';
                                } ?>" href="<?php echo e(URL::to('/')); ?>/message">Message</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#aboutdetails" >About Info</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="<?php echo e(URL::to('/')); ?>/network/<?php echo $data['userId'];  ?>">Who to Follow</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $data['userId'];  ?>">Profile</a>
          </li>
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="<?php echo e(URL::to('/')); ?>/marches_info/<?php echo $data['userId'];  ?>" >Matches</a>
          </li>
         <!-- onclick="marches_tab('<?php //echo $usrId_ ; ?>')" -->
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="<?php echo e(URL::to('/')); ?>/network/<?php echo $data['userId'];  ?>">Network</a>
          </li>
          <!-- onclick="my_event_tab('<?php //echo $usrId_ ; ?>')" -->
          <li class="nav-item">
            <a class="nav-link mobile_view"  href="<?php echo e(URL::to('/')); ?>/myevent_info/<?php echo $data['userId'];  ?>" > My Event </a>
          </li>
...
<select class="f-control f-dropdown select" id="gg_country" name="gg_country" onchange="ggCountry()" placeholder="Select Country">
   <?php 
              ...
              if(!empty($country)){
                ...
                <option value="<?php echo $value->id ; ?>"  data-country="<?php echo $value->name ; ?>" data-thumbnail="<?php echo e(URL::to('/public/website')); ?>/logo/<?php echo $value->logo ; ?>"  ><?php echo $value->name ; ?></option>
              <?php  }
              } ?>
</select>
    ...
    <?php } ?>
            ...
            <div class="notify_list_wrap">
              <?php if (count($noti_data['notification']) > 0) { ?>
                <div class="notify_head">
                  <h4>New</h4>
                  <a href="<?php echo e(URL::to('/')); ?>/notification/<?php echo $data['userId'];  ?>">See all</a>
                </div>
      ...
      <div class="userbtn dropdown">
        ...
        <div class="dm_bx dropdown-menu" aria-labelledby="dropdownMenuLink">
          ...
          <div class="user_name">
		  <a href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $data['userId'] ?>">
          ...
          <ul class="drp_menu">
              <li><a href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $data['userId'] ?>"><i class="ri-profile-line"></i> Profile</a></li>
              <!-- <li><a href="<?php echo e(URL::to('/')); ?>/logout"><i class="ri-logout-box-r-line"></i> Logout</a></li>     -->          
            </ul>

          <div class="logout">
            <a href="<?php echo e(URL::to('/')); ?>/logout"><i class="ri-logout-box-r-line"></i> Logout</a>
          </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $("#search_user").keyup(function() {
      ...
      value = $(this).val();
      if(value==''){
        $('#user_search_inner').html('<div class="notify_bx"><div class="no_record_box"><div class="media"><img src="<?php echo e(URL::to("/public/website")); ?>/images/no_record/c_norecrd.png" alt=""> </div><p>User Not found</p></div></div>');
      }
            ...
            if (res.length > 0) {
              ...
              $.each(res, function(key, item) {
               ...
               if (item.is_follow==1) {
                  ...
                  var request_button = '<div class="btn_grp"><button  id=' + item.id + '_send_request class="btn" ><a style="text-decoration: none !important;" href="<?php echo e(URL::to('/')); ?>/message/' + item.id + '">Send Message</a></button></div>';
                }else{
                ...
                if (item.city!=null || item.country!=null) {
                  var loc = '<div class="prof_location"><img src="<?php echo e(URL::to("/public")); ?>/user_image/map-marker-alt.svg" alt=""><ul><li>' + item.city + '</li> <li>' + item.country + '</li></ul></div>'
                } else {
                  var loc = "";
                }
                $('#user_search_inner').append('<div class="crd_bx"><div class="user_avtar"><a style="text-decoration: none !important;" href="<?php echo e(URL::to('/')); ?>/profile/' + item.id + '"><div class="img_bx"><img src="' + item.image + '" alt=""></div><div class="user_details"><h3>' + item.name + '</h3></a>' + loc + '' + fri + '</div></div>' + request_button + '</div>')
...
<?php /**PATH D:\xampp\htdocs\golden\resources\views/includes/website/header.blade.php ENDPATH**/ ?>