    ...
    <div class="myntwrkbx">
        ...
        <div class="f_card" id="followers_list_data" style="display:none">
            ...
            <div class="fcrd_rptr" id="followerDiv_<?php echo $follow->id ;?>">
                <div class="fpbx">
                     <a href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $follow->id  ?>">
...
<?php } ?>
        ...
        //    <?php echo ($followerData < 3)?'fstbxf':'' ; ?/>
            ...
            <div class="fcrd_rptr" >
                <div class="fpbx">
                     <a href="<?php echo e(URL::to('/')); ?>/profile/<?php echo $followings->id  ?>">
...
<?php echo $__env->make('includes.website.ajax_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\golden\resources\views/website/pages/following/following_page.blade.php ENDPATH**/ ?>