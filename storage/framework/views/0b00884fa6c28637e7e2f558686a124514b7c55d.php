<div id="onlinecontact" class="">
  ...
  <div class="memu_inner">
    <div class="menu_inner_list">
      ...
      <ul class="nav nav-tabs" role="tablist">
		...
		<a style="text-decoration: none !important;" href="<?php echo e(URL::to('/')); ?>/message/<?php echo $online_contacts->id; ?>">
  ...
  <div class="ofl_notfound">
    <div class="media"><img src="<?php echo e(URL::to('/public/website')); ?>/images/no_record/l_norecrd.png" alt=""> </div>
    <h3>No record Found</h3>
    <p>Online Friends not yet</p>
  </div>
  <?php } ?>
</div><?php /**PATH D:\xampp\htdocs\golden\resources\views/leftmenu/onlinecontacts.blade.php ENDPATH**/ ?>