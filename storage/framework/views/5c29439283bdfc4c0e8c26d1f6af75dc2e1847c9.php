<form id="add_photo_form_id" method="post" action="javascript:void(0);">
					<div class="aef_bx">
						...
						<div class="form-group">
							...
							<input id="file-upload" name="image[]" type="file"  accept="image/*" multiple>
...
</script><?php /**PATH D:\xampp\htdocs\golden\resources\views/add_photo_modal.blade.php ENDPATH**/ ?>