                                    ...
                                    <tr>
                                      <td style="padding:3px 0">
                                        <table style="font-family: 'roboto';  background: #f9f9f9; padding: 10px" width="100%">
                                          <tbody>
                                            <tr>
                                              <td colspan="3" style="font-size:17px;padding-bottom: 5px;text-align: center;"><a href="<?php echo e($messages); ?>" >Click here to reset your password</a> </td>
                                            </tr>
                                           <!--  <tr>
                                            	 <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: center;">
                                            	 	Password: <?php echo e($messages); ?>
...
</html><?php /**PATH C:\xampp\htdocs\golden\resources\views/emails/password.blade.php ENDPATH**/ ?>