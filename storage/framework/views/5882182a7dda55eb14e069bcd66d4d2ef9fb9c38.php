...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/website/css/style.css?v=123')); ?>">
	<link rel="stylesheet" href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
	<link rel="stylesheet" href="<?php echo e(asset('public/website/css/fm.selectator.jquery.css')); ?>">

    <link href="<?php echo e(URL('/').'/public/website/group_chat/jquery.multiselect.css'); ?>" rel="stylesheet" type="text/css">
                    ...
                    <div class="memu_inner">
                        ...
                        <div class="menu_inner_list user_profile_menu chattab">
                            ...
                            <ul class="nav nav-tabs" role="tablist">         
                                <?php $__currentLoopData = $group_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item " id="userList_<?php echo e($user->id); ?>" role="presentation">
                                    <button class="nav-link usrlist" id="<?php echo e($user->id); ?>" data-bs-toggle="tab"
                                        ...
                                        <span class="nk-menu-img">
                                           ...
                                           <img id="add_notfi_no_img_<?php echo e($user->id); ?>" src="<?php echo e($user->groupImg); ?>">
                                       <?php } ?>

                                        </span>
                                        <span class="nk-menu-text">
                                            <h3 id="add_notfi_no_<?php echo e($user->id); ?>"><?php echo e($user->group_name); ?>                                             
...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="upload_img">
       <img id="def_img" src="<?php echo e(URL('/').'/public/user_image/group_icon.png'); ?>" alt="">
	   <img id="blah" />
      </div>
          <div class="plus">
...
<div class="sucmssg_box" id="create_group" style="display:none">
  ...
  <div class="modal fade basic_infofrom mang_memb_modal" id="manage-members" tabindex="-1" aria-labelledby="manage-membersLabel" aria-hidden="true">
	...
	<script src="<?php echo e(asset('public/website/js/custom.js')); ?>"></script>
	<script src="<?php echo e(asset('public/website/js/fm.selectator.jquery.js')); ?>"></script>
...
</html><?php /**PATH D:\xampp\htdocs\golden\resources\views/website/group/index.blade.php ENDPATH**/ ?>