                   ...
                   <!--  <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"> -->
                        <div class="mg_user_group">
                            <div class="mg_user_img">
                                ...
                                <?php } else { ?>
                                    <img src="<?php echo e(URL('/').'/public/user_image/group_icon.png'); ?>" alt="">
                                <?php } ?>
                            </div>
                            <div class="cont_mg" >
                                <?php //$t = array(4, 5, 6, 7); 
// data-bs-toggle="modal" data-bs-target="#creatgroupmodal"
                                ...
                                <h4><?php echo $groupMember ; ?> members</h4>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#manage-members">
                                <span>
                    ...
                    <ul>
                        <li>
                            <?php if(($message->from != Auth::id())){ ?>
                                <span><img src="<?php echo e($message->groupImg); ?>" alt=""></span>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title" id="manage-membersLabel">IOS Team </h5>
                <p>7 members</p>
                ...
                <div class="members_popup">
                    <form id="" action="javascript:void(0);" method="post">
                        <div class="srch_mb_wrapp">
                            ...
                            <div class="add_btn" data-bs-toggle="modal" data-bs-target="#manage-members-add">
...
</div><?php /**PATH C:\xampp\htdocs\golden\resources\views/website/group/message.blade.php ENDPATH**/ ?>