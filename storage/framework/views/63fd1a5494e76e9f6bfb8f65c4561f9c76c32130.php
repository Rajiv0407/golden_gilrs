...
$event_type=checkAddRole($user_per_info,15);
$edit_event_type=checkEditRole($user_per_info,16);
$status_event_type=checkStatusRole($user_per_info,16);
$delete_event_type=checkDeleteRole($user_per_info,16);
          ...
          <div class="carManagement__wrapper">
                <div class="breadcrumbWrapper d-flex align-items-center justify-content-between ">
                    ...
                    <div class="rightButton">
                        <a href="javascript:void(0);" onclick="showModal('add_body456')" class="border-btn d-flax" ><i class="bi bi-plus"></i><span>Add Event Type</span></a>
                    </div>
					<?php } ?>
                </div>
                ...
                <div class="filterWrapper">
                    <div class="form master_event">
                        <div class="row align-items-center">
                            ...
                            <label for="Manufacture">Event Type Name</label>
                            <input type="text" class="form-control" id="fState_Search" placeholder="Event Type Name">
                        </div> 
                            </div>
                            <div class="col-lg-3">
                            <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form modal-form">
                    <div class="form-group">
                        <label for="Manufacture">Event Type Name</label>
                         <input type="text" name="event_type" id="event_type"  class="form-control" placeholder="Event Type">
				...
				<div class="form modal-form">
                    <div class="form-group">
                        <label for="Manufacture">Event Type Image</label>
                         <input type="File" name="event_type_image" id="event_type_image"  class="form-control" placeholder="Event Type Image">
...
<script type="text/javascript">
     ...
     $(document).ready(function($k){
        ...
        datatablePagination($k); 
          var edit_event_type_per='<php echo $edit_event_type; ?>?';
		  var status_event_type_per='<?php echo $status_event_type; ?>';
		  var delete_event_type_per='<?php echo $delete_event_type; ?>';
              ...
              columnDefs: [  
                  {
                  ...
                  } ,
                       {
                        ...
                        
                          {
                            ...
                            "mRender" : function(data, type, full){
                                ...
                                if(edit_event_type_per== 1 && delete_event_type_per== 1){
									var editEventType='<div class="align-items-center d-flex"> <div class="more_n"> <i class="bi bi-three-dots-vertical" type="button" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"></i> <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink"> <li><a class="dropdown-item" href="javascript:void(0);"  onclick="editNFor('+full["id"]+')" >Edit</a></li></ul> </div> <div style="text-align: right;"> <label class="switch">';
								}else if(edit_event_type_per==1 ){
									var editEventType='<div class="align-items-center d-flex"> <div class="more_n"> <i class="bi bi-three-dots-vertical" type="button" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"></i> <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink"> <li><a class="dropdown-item" href="javascript:void(0);"  onclick="editNFor('+full["id"]+')" >Edit</a></li> </ul> </div> <div style="text-align: right;"> <label class="switch">';
								}else if(delete_event_type_per==1){
									var editEventType='<div class="align-items-center d-flex"> <div class="more_n"> <i class="bi bi-three-dots-vertical" type="button" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false"></i> <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink"><li><a class="dropdown-item" href="javascript:void(0);" onclick="ConfirmDelete('+full['id']+')" >Delete</a></li> </ul> </div> <div style="text-align: right;"> <label class="switch">';
									
								}else{
									var editEventType='<div style="text-align: right;" > <label class="switch">';  	
								}

                                var action = editEventType;
                            if(status_event_type_per == 1){
                            if(full['status']==1){
                    ...
                    ajax: {
                              url: '<?php echo URL::asset('event_type_datatable'); ?>', 
                            },
                     columns : [            
                                { data:'id' },
                                { data:'type_name' },
...
</script><?php /**PATH C:\xampp\htdocs\golden\resources\views/admin/master/event_type/index.blade.php ENDPATH**/ ?>