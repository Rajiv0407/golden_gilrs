                ...
                <div class="breadcrumbWrapper d-flex align-items-center justify-content-between"  >
					...
					<div class="rightButton d-flex">
                        <a href="javascript:void(0);" onclick="showModal('add_users')" class="border-btn d-flax" ><i class="bi bi-plus"></i><span>Add Users</span></a>
						 <a style="margin-left:15px;" href="<?php echo e(URL::to('/')); ?>/administrator/dashboard#role" onclick="roleManagment();" class="border-btn d-flax" ><i class="bi bi-plus"></i><span>Manage Role</span></a>
                    </div> 
...
<script type="text/javascript">
 ...
 $('#dataTable').DataTable({
      ...
      columnDefs: [  
            ...
            ajax: {
                      url: '<?php echo URL::asset('admin_users_datatable'); ?>',
                    },
             columns : [
...
<?php /**PATH C:\xampp\htdocs\golden\resources\views/admin/adminUsersManagement/index.blade.php ENDPATH**/ ?>