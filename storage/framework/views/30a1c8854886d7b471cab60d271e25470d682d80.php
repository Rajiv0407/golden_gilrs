                ...
                <div class="filterWrapper">
                    <div class="form filterWrapper__l s_I">
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Country_Search" placeholder="Country">
                        </div> 
    ...
    <div class="modal-dialog modal-dialog-slideout add_motification_modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="javascript:void(0);" method="post" id="countryForm" enctype="multipart/form-data">  
         
                <div class="form modal-form">
                    <div class="form-group">
                        <label for="Manufacture">Country</label>
                         <input type="text" name="country" id="country"  class="form-control" placeholder="Country">
                         <span id="err_country" class="err" style="color:red"></span>
                    </div>
                </div>				
				<div class="form modal-form">
							...
							<span id="err_country_status" class="err" style="color:red"></span>
                </div>
                <div class="mt-4">
...
<script type="text/javascript">
              ...
              columnDefs: [  
                  {
                    ...
                    ajax: {
                              url: '<?php echo URL::asset('country_datatable'); ?>', 
                            },
                     columns : [            
                                { data:'id' },
                                { data:'name' },
    ...
    function submitNotifyFor(){
       ...
       if(country==''){
          $('#err_country').html('Please enter country.');
			...
			$('#err_country_status').html('Please select status.');
		}else {	
    ...
    function updateNFor(){
	  ...
	  var edit_country_status= $('#edit_country_status').val() ;
      ajaxCsrf();
      $('.err').html('');
      if(edit_country==''){  
         $('#err_edit_country').html("Please enter country");
      }else if(edit_country_status==''){
        $('#err_edit_country_status').html("Please select status");
	  }else{
        $('.err').html('');
...
function clearNFor(){
   ...
   function searchNFor(){
        ...
        var fTitleS=$("#Country_Search").val();
...
</script><?php /**PATH C:\xampp\htdocs\golden\resources\views/admin/master/country/index.blade.php ENDPATH**/ ?>