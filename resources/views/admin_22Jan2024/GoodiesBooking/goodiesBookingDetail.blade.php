...
$weight = isset($userInfo->weight)?$userInfo->weight:'' ;
  ...
  <div class="carManagement__wrapper">
    <div class="breadcrumbWrapper">
        <nav aria-label="breadcrumb">
            <h3 class="fs-5 m-0 fw-500">Goodies Booking Details</h3>
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="{{URL::to('/')}}/administrator/dashboard#index" onclick="dashboard()">Home</a></li>
              
               <li class="breadcrumb-item active" aria-current="page"> <a  href="{{URL::to('/')}}/administrator/dashboard#goodiesbooking" onclick="goodiesBookingRequest()">Goodies Booking Listing </a>  </li>  
                
                <li class="breadcrumb-item active" aria-current="page">Goodies Booking Details</li>
            </ol>
        </nav>
    </div>

    <div class="main_bx">
        <h3>Goodies Booking Details</h3>

                <div class="filterWrapper">
                    <div class="bcc__wrapper godies_dtls">
                        <div class="custmer_dtls">
                            
                            <p>
                                <span>Booking Id : </span>
                                <span>#<?php echo  $book_info['book_id']; ?></span>
                            </p>
                            <p>
                                <span>Booking Date :</span>
                                <span><?php echo  $book_info['booking_request_date']; ?></span>
                            </p>
                            <p>
                                <span>Event name : </span>
                                <span><?php echo  $book_info['event_name']; ?></span>
                            </p>
                            <p>
                                <span>Status :</span>
								<?php if($book_info['status'] == 1){  ?>
                                <span style="color:#f8b208"><?php echo  $book_info['status_']; ?></span>
								<?php }else if($book_info['status'] == 2){ ?>
								<span style="color:green"><?php echo  $book_info['status_']; ?></span>
								<?php }else{ ?>
                    ...
                    <div class="bcc__wrapper godies_dtls">
                        ...
                        <div class="custmer_dtls">
							...
							<p>
                                ...
                                <span><?php echo $address_line_1.' '.$address_line_1.''.$zip_code; ?></span> 
                                 <?php }else{ ?>
								<span>NA</span>
								<?php } ?>								
                            </p>
			 ...
			 <div class="c_Doc c_dtl">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="Image-tab" data-bs-toggle="tab" data-bs-target="#Image" type="button" role="tab" aria-controls="Image" aria-selected="true" onclick="userDetailData('{{$userId}}',1,'Image')" >Image</button>
                        </li>   
                        <li class="nav-item" role="presentation">
