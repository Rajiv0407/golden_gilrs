    ...
    <div class="modal-dialog modal-dialog-slideout add_motification_modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form modal-form">
                    <div class="form-group">
                        <label for="event_price">Event Price</label>
                         <input type="number" name="event_price" id="event_price"  class="form-control" placeholder="Event Price">
                         <span id="err_price" class="err" style="color:red"></span>
                    </div>
                </div>
				<div class="form modal-form">
                    <div class="form-group">
                        <label for="event_price">Event Seats</label>
                         <input type="number" name="event_seats" id="event_seats"  class="form-control" placeholder="Event Price">
                ...
                <div class="mt-4">
                    <a href="javascript:void(0);" id="upload"  onclick="submitEvent()" class="search-btn">Submit</a>
    ...
    function submitEvent(){
       ...
       if(event_name==''){
          $('#err_event_name').html('Please enter event name.');
			...
			$('#err_event_price').html('Please enter event price');
		}else if(event_price==''){
			$('#err_event_price').html('Please enter event price');
		}else if(event_seats==''){
			$('#err_event_seats').html('Please enter event seats number');
      ...
      ajaxCsrf();
       ...
       if(event_name==''){
          $('#err_edit_event_name').html('Please enter event name.');
			...
			$('#err_edit_event_price').html('Please enter event price');
		}else if(event_date==''){
