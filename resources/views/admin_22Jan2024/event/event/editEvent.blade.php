...
<form action="javascript:void(0);" method="post" id="editEventForm" enctype="multipart/form-data">
    ...
    <div class="form modal-form">  
		...
		<div class="form modal-form">  
		<div class="form-group">  
            <label for="edit_event_seats">Event seats</label>
             <input type="number" name="edit_event_seats" id="edit_event_seats"  value="<?php echo isset($eventInfo->total_seats)?$eventInfo->total_seats:'' ; ?>" class="form-control" placeholder="Event Price">
             <span id="err_edit_event_price" class="err" style="color:red"></span>
        </div>
		</div>
		<div class="form modal-form">  
