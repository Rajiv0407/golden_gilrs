						...
						<ul>
							...
							<li>
								<button type="button" class="adnebtn" data-bs-toggle="modal" data-bs-target="#audience_modal" >
									<span class="icon">
										<img src="{{URL::to('/public/website')}}/images/icon/public.png" id="createPost" alt="">
									</span>
					...
					<div class="post_user">
						<div class="user_avtar">
							...
							<div class="user_details">
								<div>
									<h3><a href="{{URL::to('/')}}/profile/<?php echo $post_infos['post_user_id']; ?>">
...
<script type="text/javascript" src="{{URL::to('/public/website')}}/js/new.js?v={{ time() }}"></script>
<!-- edit post modal ---- -->
<script type="text/javascript">
	...
	$("#image").change(function (e) {
		...
		if (fileUploadSize > fileSize) {
			...
			var j = parseInt(totalPreviewImg);
	...
	$('#output_image').on('click', '.remove_img_preview', function () {
		...
		// 	const file = files[i];
			...
			// }			
			filesToUploadPost = filesToUploadPost.filter(function( obj ) {
			return obj.name !== id;
			});
			if (files.length == 1) {
				$("#image").val("");
