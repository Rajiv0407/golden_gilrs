...
<div class="sell_box" id="event_detail">
  <div class="head">
    <ul class="step_bar">
      <li><a <?php if($data['isLogin']==1){ ?>href="{{URL::to('/')}}/goodies" <?php }else{ ?>href="javascript:void(0);" <?php } ?> >Goodies</a></li>
      ...
      <form id="booking_goodies" action="javascript:void(0);" method="post">
        ...
        <div class="pd_tkt_bx">
          ...
          <div class="pdt_fr">
            ...
            <button type="button" class="btn" onclick="send_goodies_confirm(<?php echo $data['isLogin'] ; ?>);">Join</button>
          </div>
        </div>
      </form>  
