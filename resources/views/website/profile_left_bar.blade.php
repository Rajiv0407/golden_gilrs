    ...
    <div class="menu_inner_list user_profile_menu">
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item" role="presentation">
          <!-- <a class="dropdown-item" href="{{URL::to('/')}}/profile/</?php echo $user_id;  ?>"></a> -->
          <a class="dropdown-item" href="{{URL::to('/')}}/profile/<?php echo $user_id;  ?>">
...
<?php if($user_id == $data["userId"]){ ?>
        <li class="nav-item" role="presentation">
           <a class="dropdown-item" href="{{URL::to('/')}}/marches_info/<?php echo $data['userId'];  ?>" >
      ...
      <?php } ?>
        <li class="nav-item" role="presentation">
          <!-- <a class="dropdown-item" href="{{URL::to('/')}}/network/</?php echo $user_id;  ?>"></a> -->
          <?php 
        ...
        <li class="nav-item" role="presentation">
           <a class="dropdown-item" href="{{URL::to('/')}}/myevent_info/<?php echo $data['userId'];  ?>"  >
