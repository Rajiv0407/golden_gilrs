  ...
  <div class="carManagement__wrapper">
    <div class="breadcrumbWrapper">
        <nav aria-label="breadcrumb">
            <h3 class="fs-5 m-0 fw-500">Event Booking Details</h3>
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="{{URL::to('/')}}/administrator/dashboard#index" onclick="dashboard()">Home</a></li>
              
               <li class="breadcrumb-item active" aria-current="page"> <a  href="{{URL::to('/')}}/administrator/dashboard#eventbooking" onclick="eventBookingRequest()">Event Booking Listing </a>  </li>  
                
                <li class="breadcrumb-item active" aria-current="page">Event Booking Details</li>
            </ol>
        </nav>
    </div>
    <div class="main_bx">
