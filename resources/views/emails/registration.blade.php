                            ...
                            <tr>
                              <td valign="top" style="font-family:Arial,Sans-serif;font-size:12px">
                                ...
                                <div style="background: #3d3935;padding: 10px 20px;">
                                  ...
                                  <img src="https://goldengirls.intigate.co.in/public/website/images/logo.png" alt="logo" style="width:280px;">            
                                 </a>
                                </div>
                                <table style="font-family:'roboto';width: 100%;     margin-top: 20px;padding: 20px;">
                                  <tbody>
                                    <tr>
                                      <td style="font-size:23px;padding:5px 0;padding-bottom: 40px;"><b> Hi {{$name}} ! </b></td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td style="padding:3px 0">
                                        <table style="font-family: 'roboto';  background: #f9f9f9; padding: 10px" width="100%">
                                          <tbody>
                                            <tr>
                                              <td colspan="3" style="font-size:17px;padding-bottom: 5px;text-align: center;"> Your registration detail: </td>
                                            </tr>
                                            <tr>
