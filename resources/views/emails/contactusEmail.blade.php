                                    ...
                                    <tr>
                                      <td style="padding:3px 0">
                                        <table style="font-family: 'roboto';  background: #f9f9f9; padding: 10px" width="100%">
                                          <tbody>
                                            <tr>
                                              <td colspan="3" style="font-size:17px;padding-bottom: 5px;text-align: left;"> <b>Enquiry detail:</b> </td>
                                            </tr>
                                            <tr>
                                            	 <td colspan="3" style="font-size:14px;padding-bottom: 5px;    text-align: left;">
                                            	<b> Name: </b> {{ $name }}
                                            	 </td>
                                            </tr>
                                            <tr>
